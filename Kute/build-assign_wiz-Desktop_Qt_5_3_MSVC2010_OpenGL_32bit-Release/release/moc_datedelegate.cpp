...
#include "../../assign_Wiz/datedelegate.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_datedelegate_t, stringdata) + ofs \
...
const QMetaObject datedelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_datedelegate.data,
      qt_meta_data_datedelegate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_datedelegate.stringdata))
