...
public:
    ...
    void setupUi(QWidget *apr_Wiz)
    {
        ...
        tablLayout = new QFrame(subLayout);
        tablLayout->setObjectName(QStringLiteral("tablLayout"));
        tablLayout->setMaximumSize(QSize(400, 16777215));
        tablLayout->setFrameShape(QFrame::StyledPanel);
        tablLayout->setFrameShadow(QFrame::Raised);
        horizontalLayout_3 = new QHBoxLayout(tablLayout);
        horizontalLayout_3->setSpacing(6);
        horizontalLayout_3->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_3->setObjectName(QStringLiteral("horizontalLayout_3"));
        tabv = new QTableView(tablLayout);
        ...
        horizontalLayout_3->addWidget(tabv);


        horizontalLayout_4->addWidget(tablLayout);
